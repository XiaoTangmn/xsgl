	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">作者账号</label> 
							<input type="text" name="zuozhezhanghao" placeholder="作者账号" class="form-control-i">
							</div>
																								<div class="form-group">
							...
							<input type="text" name="zuozhexingming" placeholder="作者姓名" class="form-control-i">
							</div>
																																			<div class="form-group">
							...
							<input type="text" name="shenfenzheng" placeholder="身份证" class="form-control-i">
							</div>
